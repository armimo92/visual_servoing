...
Eigen::Vector4f err_dot;

Eigen::Vector4f imgFeat_est;
Eigen::Vector4f imgFeat_dot_est;
...
Eigen::Vector3f quad_vel_VF_real;
...
float quad_mass = 1.71;
float gravity = 9.81;
float fz = quad_mass * gravity;
/////////////////////////Functions///////////////////////////////
...
int main(int argc, char *argv[])
{
    ...
    ros::Publisher linear_forces_pub = nh.advertise<geometry_msgs::Vector3>("quad_linear_forces",100);
    ...
    geometry_msgs::Vector3 linear_forces_var;
    ...
    linear_forces_var.x = 0;
    linear_forces_var.y = 0;
    linear_forces_var.z = fz;
    linear_forces_pub.publish(linear_forces_var);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////        
        ...
        */
        ...
        quad_linear_forces_VF = (quad_mass * quad_accel_VF) + (quad_mass * skewOmega(quad_attVel) * quad_vel_BF);
        Fq = (RotationMatrix(quad_att).transpose() * quad_mass*gravity*e3) - quad_linear_forces_VF;
        //quad_linear_forces_VF = (quad_mass * quad_accel_VF) + quad_mass * skewMatrix(yawVel_e3) * quad_vel_VF;        
        //Fq = Rtp(quad_att(0),quad_att(1)).transpose() * (quad_mass*gravity*e3 - quad_linear_forces_VF);
        if(Fq(0) > 7)
        {
            Fq(0) = 7;
        }
        ...
        attitude_desired(0) = 0; //Roll desired
        attitude_desired(1) = 0; //Pitch desired
        ...
        //Linear forces
        linear_forces_var.x = Fq(0);
        linear_forces_var.y = Fq(1);
        linear_forces_var.z = Fq(2);
