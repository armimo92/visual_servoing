...
int main(int argc, char *argv[])
{
    ...
    desired_attitude_est << desired_attitude(0),desired_attitude(1),desired_attitude(2);
    desired_attitude_vel_est << 0,0,desired_attitude(3);
           ...
           for(int i = 0; i<=1; i++)
            {
                ...
                desired_attitude_est(i) = 0;
                desired_attitude_vel_est(i) = 0;
                x2_hat_dot(i) = 0;
                x1_hat_dot(i) = 0;             
            } 
        }
